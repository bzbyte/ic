...
use ic_types::{
    ...
    artifact::ExecCertificationMessageId,
...
impl MutablePool<ExecCertificationArtifact, ChangeSet> for ExecCertificationPoolImpl {
...
impl ValidatedPoolReader<ExecCertificationArtifact> for ExecCertificationPoolImpl {
